...
class Add_NewClass:
    def __init__(self, parent):
        ...
        self.lb5 = tk.Label(self.panel, text="Giáo viên", font=("cambria", 18, "bold"), fg="#FBA834")
        self.lb5.place(x=33, y=400)
        self.tf5 = tk.Entry(self.panel,font=("cambria", 13, "bold"))
        self.tf5.place(x=33, y=445, width=430, height=30)
        self.lb6 = tk.Label(self.panel, text="Giáo viên nước ngoài", font=("cambria", 18, "bold"), fg="#FBA834")
